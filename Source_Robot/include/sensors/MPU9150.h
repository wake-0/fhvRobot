...
#ifndef INCLUDE_SENSORS_MPU9150_H_
#define INCLUDE_SENSORS_MPU9150_H_
...
class MPU9150 {
    public:
        ...
        void GetCompassCalibration(float* calibData);
        bool GetCompass(short* mx, short* my, short* mz);

        short GetTemp();

        float getGravity() { return 9.80665f; }
        float getAGain() { return (1 / 4096.0); }
        float getGGain() { return 0.030487804878049f; }
        float getMGain() { return 0.3001221001221001f; }
        float getMRes() { return 10.*1229./4096.; }
...
#endif /* INCLUDE_SENSORS_MPU9150_H_ */
