...
public class PDUFactory {
	...
	public static SessionPDU createSessionPDU(byte[] data) {
		...
		int flags = ByteParser.intToByte(data[0]);
		int sessionId = ByteParser.intToByte(data[1]);
	...
	public static ApplicationPDU createApplicationPDU(byte[] data) {
		int flags = ByteParser.intToByte(data[0]);
		int command = ByteParser.intToByte(data[1]);
		int length = ByteParser.intToByte(data[2]);
